...
from keras.src.layers import Flatten, AveragePooling2D
...
def setup_data_generator(directory, augmentation_params, target_size=(224, 224), batch_size=32):
...
def main():
    ...
    training_set = setup_data_generator('../../dataset/train_new', augmentation_params)
    validation_set = setup_data_generator('../../dataset/validation_new', augmentation_params)
